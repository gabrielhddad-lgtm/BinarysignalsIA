    ...
    <main className="min-h-screen bg-gradient-to-br from-primary via-secondary to-primary">
      ...
      <header className="border-b border-gray-800">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-4 py-2 bg-accent text-white rounded-lg hover:bg-blue-600 transition">
              Começar
            </button>
          </div>
        </nav>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <button className="px-8 py-3 bg-accent text-white rounded-lg text-lg font-semibold hover:bg-blue-600 transition">
            Acessar Platform
          </button>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { icon: '⚡', title: 'Sinais Rápidos', desc: 'Notificações instantâneas' },
          ].map((feature, i) => (
